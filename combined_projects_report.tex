...
\begin{titlepage}
    ...
    {\large \textbf{Projeler:} Veritabani Guvenligi ve Yedekleme Otomasyonu}
...
\part{Veritabanı Güvenliği ve Erişim Kontrolü (Proje 3)}
...
\newpage
% =========================================================================
% PROJE 7: YEDEKLEME VE OTOMASYON
% =========================================================================

\part{Veritabanı Yedekleme ve Otomasyon Çalışması (Proje 7)}
\setcounter{section}{0}
